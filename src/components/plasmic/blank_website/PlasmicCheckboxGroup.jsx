...
import Checkbox from "../../Checkbox"; // plasmic-import: n5EHelJWAkKF/component
...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: 3P_A8tcAGXXK/css
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox___4Npm)}
          >
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox___5D3WK)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__nyoMh)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__sbds1)}
              label={"Option 3"}
              value={"option3"}
            />
          </Stack__>

...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: UOVEY_hSmjMi/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___2Odsi)}
      >
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__xAz12)}>
            <div
              className={classNames(
                projectcss.all,

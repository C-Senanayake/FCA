...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: e_5O9Bi7EuOT/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: GH_BiLohwR6s/css
  ...
  return (
    <BaseDialogTrigger
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <Stack__
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.freeBox__dTdPd)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button
            className={classNames("__wab_instance", sty.button__yWkmX)}
            label={"Open Popover"}
          />
        ),

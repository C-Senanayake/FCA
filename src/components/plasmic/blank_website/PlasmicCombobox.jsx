...
import MenuPopover from "../../MenuPopover"; // plasmic-import: K6h3lsQJ1Le-/component
import MenuItem from "../../MenuItem"; // plasmic-import: UOVEY_hSmjMi/component
import MenuSection from "../../MenuSection"; // plasmic-import: y6WNnxK48Bte/component
...
import sty from "./PlasmicCombobox.module.css"; // plasmic-import: 16qipWFi-OP_/css
...
function PlasmicCombobox__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      <div className={classNames(projectcss.all, sty.freeBox__tkMxt)}>
        {(() => {
          const child$Props = {
        ...
        >
          <div className={classNames(projectcss.all, sty.freeBox___29Ftz)}>
            <ChevronDownIcon

...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: ejTEwJ4RVLY1/css
...
function PlasmicRadio__RenderFunc(props) {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox__ioHxn)}>
        <div className={classNames(projectcss.all, sty.freeBox___2NWyf)} />
      </div>
      {renderPlasmicSlot({

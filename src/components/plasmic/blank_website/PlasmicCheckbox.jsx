...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: n5EHelJWAkKF/css
import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: gwwrxD9AFyy3/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: cGV6BCMezXwg/icon
    ...
    >
      ...
      >
        {(
          ...
          <CheckIcon
            className={classNames(projectcss.all, sty.svg__hlt7D)}
            role={"img"}
          />
        ) : null}
        {($ccVariants["indeterminate"] ? true : false) ? (
          <MinusIcon
            className={classNames(projectcss.all, sty.svg__dYySk)}
            role={"img"}
          />
        ) : null}
      </div>

...
import SliderThumb from "../../SliderThumb"; // plasmic-import: pPF7eDkPvMgj/component
...
import sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: dn6WDvz9_Dnx/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__tc8Yq)}
      >
        {$props.showLabel ? (
          <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__nLeKw)}>
        <div

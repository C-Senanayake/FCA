...
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: gyQg5w7lwwNY/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: o4eE1dqDplKa/css
...
function PlasmicTextField__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__bw4JK, {
          [sty.freeBoxiconEnd__bw4JKMotx]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__bw4JKjQxL6]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__bw4JKsbuKn]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__n7RRp, {
            [sty.freeBoxiconStart__n7RRpjQxL6]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__n7RRPsbuKn]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__pul64)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__hAcw, {
            [sty.freeBoxiconEnd__hAcwMotx]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__hAcwJQxL6]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__dEaCa)}
                role={"img"}
              />
            ),
